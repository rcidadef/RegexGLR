...
public class TokenSet {
	...
	public static String stripAccents(String s) {
		...
		ns = s.replaceAll("[áàâã]", "a");
		ns = ns.replaceAll("[ÃÁÀÂ]", "A");
		ns = ns.replaceAll("[éêÉÊ]", "e");
		ns = ns.replaceAll("í", "i");
		ns = ns.replaceAll("Í", "I");
		ns = ns.replaceAll("[óôô]", "o");
		ns = ns.replaceAll("[ÕÓÔ]", "O");
		ns = ns.replaceAll("ú", "u");
		ns = ns.replaceAll("Ú", "U");
		ns = ns.replaceAll("ç", "c");
		return ns;
	}
	...
	/**
	 * União entre dois Tokensets. Segue a mesma definição de união da teoria
	 * dos conjuntos.
	 */
	...
	/** Retorna o tipo do Tokenset, caso só tenha um tipo, ou -1 caso contrário. */
	...
	/** Retorna true se Tokenset contém símbolos, ou false caso contrário. */
